...
// replay button function => toggledisplayoverlay and reset the game 
    function replay (){
        toggleWinOverlay();
    ...
    let replayBtn = document.querySelector(".playAgain")
...
//      if the array is full and won has not been set to true, set tie to true and overlay Tie
        const checkTie = () => {
